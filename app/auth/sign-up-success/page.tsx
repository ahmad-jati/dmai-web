    ...
    <div className="w-full">
      <Section className="flex items-center gap-8 bg-white">
        ...
        <div className="flex-1 flex flex-col gap-3.5 items-start text-foreground">
          ...
          <p className="text-lg">
            Silakan <span className="font-bold">cek email </span> untuk mengonfirmasi akun sebelum masuk ke platform. <span className="block"></span> Kamu bisa menutup tab ini.
          </p>
        </div>
      </Section>
    </div>
