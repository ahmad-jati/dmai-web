...
export function Footer() {
  return (
    <footer id="footer-app" className="w-full flex flex-col items-center justify-center text-center gap-2 p-6 bg-white dark:bg-secondary text-foreground md:rounded-t-5xl rounded-t-xl border border-foreground border-b-0">
