...
export function Footer() {
  return (
    <footer className="w-full flex flex-col items-center justify-center text-center gap-2 p-6 bg-white sm:rounded-t-5xl rounded-t-3xl border border-foreground border-b-0">
