          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="sm:w-44 w-fit bg-background">
              <DropdownMenuGroup>
                ...
                <DropdownMenuItem
                  onClick={logout}
                  className="[&_svg]:size-4 flex items-center gap-2 w-full rounded-md border-2 border-destructive/20 text-destructive hover:bg-destructive/10 hover:text-destructive!"
                >
                  <SignOutIcon />
                  Logout
                </DropdownMenuItem>
