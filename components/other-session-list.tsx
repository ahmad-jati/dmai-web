...
function SessionCardSkeleton() {
  return (
    <div className="flex flex-row-reverse gap-3 bg-background rounded-[20px] border border-foreground/20 w-full overflow-hidden animate-pulse 2xs:h-32 h-28">
      {/* image placeholder — right side */}
      <div className="2xs:w-28 w-24 shrink-0 bg-foreground/8 rounded-r-[17px]" />
      {/* text side */}
      <div className="flex flex-col justify-between p-3 flex-1 min-w-0">
        <div className="flex flex-col gap-2">
          <div className="2xs:h-3.5 h-3 bg-foreground/10 rounded w-3/4" />
          <div className="2xs:h-3 h-2.5 bg-foreground/8 rounded w-full" />
        </div>
        <div className="flex flex-col gap-1.5">
          <div className="2xs:h-2.5 h-2 bg-foreground/8 rounded w-1/2" />
          <div className="2xs:h-2.5 h-2 bg-foreground/6 rounded w-2/5" />
        </div>
      </div>
    </div>
  )
