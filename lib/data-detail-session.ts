...
export const data_session: SessionData[] = [
...

  {
    ...
    duration: '15 menit',
    instructions: [
      { step: 1, title: 'Check-in Tubuh', description: 'Pindai tubuhmu dari ujung kepala hingga kaki. Di mana ada ketegangan? Perhatikan tanpa perlu mengubah apa pun.', duration_seconds: 90, image: '/serene1.png' },
      { step: 2, title: 'Skala Energi', description: 'Dalam skala 1–10, seberapa bertenaga kamu hari ini? Tidak ada jawaban yang salah — ini hanya laporan jujur.', duration_seconds: 60, image: '/serene2.png' },
      { step: 3, title: 'Emosi Saat Ini', description: 'Sebutkan satu kata yang menggambarkan perasaanmu sekarang. Pilih dari: senang, sedih, cemas, lega, bingung, marah, atau yang lainnya.', duration_seconds: 60, image: '/serene3.png' },
      { step: 4, title: 'Apa yang Mempengaruhi?', description: 'Apa satu hal yang paling memengaruhi kondisimu hari ini? Tidak perlu solusi — cukup kenali.', duration_seconds: 90, image: '/serene4.png' },
...

  {
    ...
    duration: '18 menit',
    instructions: [
      { step: 1, title: 'Mulai dengan Hadir', description: 'Duduk tegak, letakkan tangan di dada. Rasakan detak jantungmu. Tubuhmu bekerja keras untukmu setiap hari.', duration_seconds: 60, image: '/serene1.png' },
      { step: 2, title: 'Ingat Pencapaian Lalu', description: 'Pikirkan satu tantangan yang pernah berhasil kamu lewati. Tidak harus besar — cukup sesuatu yang dulu terasa susah tapi berhasil.', duration_seconds: 120, image: '/serene2.png' },
      { step: 3, title: 'Kekuatan yang Kamu Miliki', description: 'Sebutkan tiga kata sifat positif tentang dirimu. Mungkin: gigih, peduli, kreatif. Percaya pada deskripsi itu.', duration_seconds: 90, image: '/serene3.png' },
      { step: 4, title: 'Tantangan Sekarang', description: 'Bayangkan satu tantangan yang sedang kamu hadapi. Sekarang bayangkan versi dirimu yang lebih kuat menghadapinya — apa yang ia lakukan?', duration_seconds: 120, image: '/serene4.png' },
...

  {
    ...
    duration: '14 menit',
    instructions: [
      { step: 1, title: 'Terima Rasa Sepi', description: 'Rasa sepi bukan tanda kelemahan. Biarkan dirimu mengakui: "Aku sedang merasa kesepian, dan itu tidak apa-apa."', duration_seconds: 90, image: '/serene1.png' },
      { step: 2, title: 'Kamu Tidak Sendirian', description: 'Di seluruh dunia, ada jutaan orang yang merasakan hal serupa saat ini. Kamu adalah bagian dari pengalaman manusia yang universal.', duration_seconds: 90, image: '/serene2.png' },
      { step: 3, title: 'Temani Dirimu', description: 'Letakkan tangan di bahu atau di dada. Bayangkan kamu sedang merangkul diri sendiri dengan lembut. Kamu ada untuk dirimu sendiri.', duration_seconds: 120, image: '/serene3.png' },
...

  {
    ...
    duration: '16 menit',
    instructions: [
      { step: 1, title: 'Bersihkan Mental', description: 'Tutup mata. Bayangkan semua tugas dan kekhawatiran sebagai awan — biarkan mereka melayang jauh sejenak. Kamu butuh ruang jernih dulu.', duration_seconds: 90, image: '/serene1.png' },
      { step: 2, title: 'Tiga Prioritas Hari Ini', description: 'Dari semua yang perlu dilakukan, pilih hanya tiga yang paling penting. Bukan yang paling mendesak — tapi yang paling bermakna.', duration_seconds: 120, image: '/serene2.png' },
      { step: 3, title: 'Estimasi Waktu Jujur', description: 'Untuk setiap prioritas, perkirakan waktu yang realistis — bukan optimis. Tambahkan 20% untuk jeda dan gangguan tak terduga.', duration_seconds: 90, image: '/serene3.png' },
      { step: 4, title: 'Jadwalkan Jeda', description: 'Istirahat bukan pembuangan waktu — itu investasi produktivitas. Rencanakan setidaknya dua jeda pendek (5 menit) dalam harimu.', duration_seconds: 90, image: '/serene4.png' },
...

  {
    ...
    duration: '17 menit',
    instructions: [
      { step: 1, title: 'Tangkap Pikiran Negatif', description: 'Pikirkan satu pikiran negatif yang sering muncul belakangan ini. Tuliskan atau ucapkan dalam hati tanpa menghakiminya.', duration_seconds: 90, image: '/serene1.png' },
      { step: 2, title: 'Uji Kebenarannya', description: 'Tanyakan: apakah pikiran ini benar 100%? Adakah bukti yang menentangnya? Pikiran bukan fakta.', duration_seconds: 120, image: '/serene2.png' },
      { step: 3, title: 'Perspektif Lain', description: 'Apa yang akan dikatakan teman terbaikmu tentang situasi ini? Sering kali orang lain melihat kita lebih baik dari kita sendiri.', duration_seconds: 90, image: '/serene3.png' },
      { step: 4, title: 'Reframe Pikiran', description: 'Ubah pikiran negatif menjadi yang lebih seimbang. Bukan "aku selalu gagal" tapi "aku kadang kesulitan, dan itu manusiawi."', duration_seconds: 120, image: '/serene4.png' },
...

  {
    ...
    duration: '13 menit',
    instructions: [
      { step: 1, title: 'Mulai dengan Kehangatan', description: 'Gosokkan kedua telapak tanganmu hingga hangat, lalu letakkan di wajahmu. Rasakan kehangatan itu sebagai pelukan untuk dirimu sendiri.', duration_seconds: 60, image: '/serene1.png' },
      { step: 2, title: 'Ingat Seseorang yang Mengasihimu', description: 'Bayangkan seseorang yang tulus peduli padamu — bisa keluarga, teman, atau bahkan hewan peliharaan. Rasakan kasih sayang mereka.', duration_seconds: 90, image: '/serene2.png' },
      { step: 3, title: 'Arahkan Kasih ke Dirimu', description: 'Sekarang arahkan perasaan hangat itu ke dirimu sendiri. Ucapkan: "Semoga aku bahagia. Semoga aku sehat. Semoga aku damai."', duration_seconds: 120, image: '/serene3.png' },
